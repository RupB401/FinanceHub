        ...
        <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-8">
          ...
          {!showForgotPassword && (
            <div className="mt-6 space-y-3">
              ...
              <div className="bg-white/5 border border-white/20 rounded-lg p-4 text-white/70 text-xs space-y-2">
                <div><span className="font-medium">Admin:</span> admin@demo.com / admin123</div>
                <div><span className="font-medium">User:</span> user@demo.com / user123</div>
                <div><span className="font-medium">Test:</span> test@demo.com / test123</div>
              </div>
